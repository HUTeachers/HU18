...
public class FiringManagementLevels : MonoBehaviour
{
    ...
    //Work ahead gun stuff
    private int gunLevel = 0, maxGunLevel = 4;
    ...
    {
        if(gunLevel +1 <= maxGunLevel)
        {
            gunLevel++;
            Bullet = bullets[gunLevel];
        }
    }
